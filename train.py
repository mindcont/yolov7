...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-weld.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/weld.yaml', help='data.yaml path')
